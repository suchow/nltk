...
from nltk.corpus.reader import AlignedCorpusReader, CategorizedTaggedCorpusReader, WordNetCorpusReader, CorpusReader, WordListCorpusReader, ConllChunkCorpusReader, CategorizedPlaintextCorpusReader, CMUDictCorpusReader
